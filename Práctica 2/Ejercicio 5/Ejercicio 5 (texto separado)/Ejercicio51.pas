...
procedure aTexto1 (var productos: archivo_productos);
var
	txt: text; prod: reg_producto; nombre_fisico: string;
...
procedure aTexto (var productos: archivo_productos);
var
	txt: text; prod: reg_producto; nombre_fisico: string;
...
var
	i: integer; reg_d: reg_ventas; min: venta; prod: reg_producto;
...
BEGIN
	...
	// Los creo para probarlos (lo del texto1 es terrible pero es para comparar).
	...
	// Lo vuelvo a pasar para ver si funciona bien la actualización completa.	
	aTexto1(productos);
END.
